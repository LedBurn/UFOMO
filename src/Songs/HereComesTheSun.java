...
public class HereComesTheSun extends Song {
    ...
    protected void configure() {
        ...
        */
        ...
        addTiming(32.167, 36.296, new AddonsContainerAllTotems(totems, Arrays.asList(sunRed)));
        addTiming(32.167, 34.456, new AddonsContainerTotemsCircle(totems, Arrays.asList(fadeIn)));
        addTiming(34.456, 36.296, new AddonsContainerHalfTotems(totems, Arrays.asList(satGlitter), true));
        addTiming(34.456, 36.296, new AddonsContainerHalfTotems(totems, Arrays.asList(satGlitter, reverse), false));

        addTiming(36.296, 38.109, new AddonsContainerTotemsCircle(totems, Arrays.asList(changeRedToOrange)));
