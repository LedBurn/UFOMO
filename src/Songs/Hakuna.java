...
public class Hakuna extends Song{
    ...
    protected void configure() {
        ...
        //hakuna matata
        addTiming(0, 3.300, new AddonsContainerAllTotems(totems, Arrays.asList(nature)));
        addTiming(0, 2.071, new AddonsContainerAllTotems(totems, Arrays.asList(blur, fadeIn)));
        ...
        addTiming(21.288, 23.617, new AddonsContainerAllTotems(totems, Arrays.asList(alternatePinkYellow, light)));
        addTiming(21.288, 23.617, new AddonsContainerAllTotems(totems, Arrays.asList(confetti)));
        //hakuna matataaaaaa
        addTiming(23.617, 26.593, new AddonsContainerTotemsCircle(totems, Arrays.asList(rainbow, fadeIn)));
        //simba asks
        addTiming(26.593, 28.146, new AddonsContainerAllTotems(totems, Arrays.asList(nature)));
        addTiming(26.593, 28.146, new AddonsContainerAllTotems(totems, Arrays.asList(blur, spikeUp)));
        //pumba answer
        addTiming(28.146, 29.570, new AddonsContainerAllTotems(totems, Arrays.asList(nature)));
        addTiming(28.146, 29.570, new AddonsContainerAllTotems(totems, Arrays.asList(blur, spikeDown)));
        //simba asks
        addTiming(29.570, 30.799, new AddonsContainerAllTotems(totems, Arrays.asList(alternatePinkYellow)));
        addTiming(29.570, 30.799, new AddonsContainerAllTotems(totems, Arrays.asList(blur, spikeUp)));

        //pumba answer
        addTiming(30.799, 32.158, new AddonsContainerAllTotems(totems, Arrays.asList(alternatePinkYellow)));
        addTiming(30.799, 32.158, new AddonsContainerAllTotems(totems, Arrays.asList(blur, spikeDown)));

        //hafira long
        addTiming(32.158, 40.440, new AddonsContainerAllTotems(totems, Arrays.asList(nature)));
        addTiming(32.158, 40.440, new AddonsContainerAllTotems(totems, Arrays.asList(blur, dark)));
        addTiming(32.158, 40.440, new AddonsContainerAllTotems(totems, Arrays.asList(confetti)));
        ...
        //when he was a...
        addTiming(41.411, 44.387, new AddonsContainerAllTotems(totems, Arrays.asList(nature, dark)));
        addTiming(41.411, 44.387, new AddonsContainerTotemsCircle(totems, Arrays.asList(fadeIn)));

        //when he was a... biiiiiggggg
        addTiming(44.387, 48.528, new AddonsContainerAllTotems(totems, Arrays.asList(nature, light)));
        addTiming(44.387, 48.528, new AddonsContainerTotemsCircle(totems, Arrays.asList(fadeIn)));

        //timon says
        addTiming(48.528, 50.275, new AddonsContainerAllTotems(totems, Arrays.asList(alternateBlueGreen, inOut)));
        //pumba says
        addTiming(51.157, 51.957, new AddonsContainerAllTotems(totems, Arrays.asList(alternatePinkYellow, inOut)));
        //hakuna matata
        addTiming(51.957, 54.545, new AddonsContainerAllTotems(totems, Arrays.asList(nature)));
        addTiming(51.957, 54.545, new AddonsContainerAllTotems(totems, Arrays.asList(blur, fadeIn)));

        //what a wonderful phrase
        addTiming(54.545, 57.912, new AddonsContainerAllTotems(totems, Arrays.asList(pink)));
        addTiming(54.545, 57.912, new AddonsContainerAllTotems(totems, Arrays.asList(blur, fadeIn)));

        //hakuna matata
        addTiming(57.912, 59.269, new AddonsContainerAllTotems(totems, Arrays.asList(nature)));
        addTiming(57.912, 59.269, new AddonsContainerAllTotems(totems, Arrays.asList(blur, fadeIn)));
        ...
        //philosophyyyyyyyyyyyyyy
        addTiming(71.757, 74.400, new AddonsContainerAllTotems(totems, Arrays.asList(rainbow, light)));
        addTiming(71.757, 74.400, new AddonsContainerAllTotems(totems, Arrays.asList(confetti)));
        //hakuna matataaaaaa
