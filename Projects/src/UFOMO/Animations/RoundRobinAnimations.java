...
//
//    public static final Animation ROUND_ROBIN_ANIMATION1 = new RoundRobinAnimation1();
//
...
////
//            animations.add(new PixelsArrayAnimation(ufomoObject.bigCircle, circleColoring, new Addon[]{new FastFadeInOutAddon()}));
//            animations.add(new PixelsArrayAnimation(ufomoObject.mediumCircle, circleColoring, new Addon[]{new FastFadeInOutAddon()}));
//            animations.add(new PixelsArrayAnimation(ufomoObject.smallCircle, circleColoring, new Addon[]{new FastFadeInOutAddon()}));
//
//            for (int i = 0; i < ufomoObject.lines.length; i++) {
//                ConstColoring line = new ConstColoring(HSBColor.GRAY);
//                animations.add(new PixelsArrayAnimation(ufomoObject.lines[i], line ,new Addon[]{}));
//                linesColors[i] = line;
//            }
//
//            for (int i = 0; i < ufomoObject.octagon.length; i++) {
//                animations.add(new PixelsArrayAnimation(ufomoObject.octagon[i], circleColoring, new Addon[]{}));
//            }
//
////            for (int i = 0; i < ufomoObject.beam.length; i++) {
////                animations.add(new PixelsArrayAnimation(ufomoObject.beam[i], null, new Addon[]{alternateAddon}));
////            }
//        }
//    }
//}
